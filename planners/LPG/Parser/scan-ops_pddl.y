...
functions_list
/**
 * Added by A. Bonisoli for handling return types of functions.
 * TODO: it is not returning the type, just parsing it. 
 */
| 
OPEN_PAREN  NAME typed_list_variable  CLOSE_PAREN type
{
